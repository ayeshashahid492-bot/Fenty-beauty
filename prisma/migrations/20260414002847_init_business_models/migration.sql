...
CREATE TABLE "CustomShade" (
    ...
    CONSTRAINT "CustomShade_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "CustomShade_customerId_idx" ON "CustomShade"("customerId");
...
-- AddForeignKey
ALTER TABLE "CustomShade" ADD CONSTRAINT "CustomShade_customerId_fkey" FOREIGN KEY ("customerId") REFERENCES "Customer"("id") ON DELETE CASCADE ON UPDATE CASCADE;
